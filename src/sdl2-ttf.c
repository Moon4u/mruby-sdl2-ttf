...
mrb_mruby_sdl2_ttf_gem_init(mrb_state *mrb)
{
  ...
  mrb_define_module_function(mrb, mod_Ttf, "init",                  mrb_sdl2_ttf_init,                ARGS_NONE());
  mrb_define_module_function(mrb, mod_Ttf, "quit",                  mrb_sdl2_ttf_quit,                ARGS_NONE());
  mrb_define_module_function(mrb, mod_Ttf, "is_init?",              mrb_sdl2_ttf_was_init,                ARGS_NONE());

	mrb_define_method(mrb, class_Font, "initialize",    mrb_sdl2_ttf_font_initialize,    ARGS_REQ(2) | ARGS_OPT(1));
	mrb_define_method(mrb, class_Font, "free",          mrb_sdl2_ttf_font_free,          ARGS_NONE());
  mrb_define_method(mrb, class_Font, "destroy",       mrb_sdl2_ttf_font_free,          ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_style",       mrb_sdl2_ttf_font_get_style,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "set_style",       mrb_sdl2_ttf_font_set_style,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "get_outline",       mrb_sdl2_ttf_font_get_outline,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "set_outline",       mrb_sdl2_ttf_font_set_outline,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "get_hinting",       mrb_sdl2_ttf_font_get_hinting,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "set_hinting",       mrb_sdl2_ttf_font_set_hinting,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "get_height",       mrb_sdl2_ttf_font_get_height,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_ascent",       mrb_sdl2_ttf_font_get_ascent,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_descent",       mrb_sdl2_ttf_font_get_descent,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_lineskip",       mrb_sdl2_ttf_font_get_lineskip,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_kerning",       mrb_sdl2_ttf_font_get_kerning,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "set_kerning",       mrb_sdl2_ttf_font_set_kerning,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "get_faces",       mrb_sdl2_ttf_font_get_faces,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "face_is_fixed_width?",       mrb_sdl2_ttf_font_face_fixed_width,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_face_family_name",       mrb_sdl2_ttf_font_get_face_family_name,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_face_style_name",       mrb_sdl2_ttf_font_get_face_style_name,      ARGS_NONE());
  mrb_define_method(mrb, class_Font, "get_glyph_index",       mrb_sdl2_ttf_font_get_glyph_index,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "get_glyph_metric",       mrb_sdl2_ttf_font_get_glyph_metric,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "size_text",       mrb_sdl2_ttf_font_get_size_text,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "size_UTF8",       mrb_sdl2_ttf_font_get_size_UTF8,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "size_UNICODE",       mrb_sdl2_ttf_font_get_size_UNICODE,      ARGS_REQ(1));
  mrb_define_method(mrb, class_Font, "render_text",       mrb_sdl2_ttf_font_render_text,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_UTF8",       mrb_sdl2_ttf_font_render_UTF8,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_UNICODE",       mrb_sdl2_ttf_font_render_UNICODE,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_glyph",       mrb_sdl2_ttf_font_render_glyph,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_text_shaded",       mrb_sdl2_ttf_font_render_text_shaded,      ARGS_REQ(9));
  mrb_define_method(mrb, class_Font, "render_UTF8_shaded",       mrb_sdl2_ttf_font_render_UTF8_shaded,      ARGS_REQ(9));
  mrb_define_method(mrb, class_Font, "render_UNICODE_shaded",       mrb_sdl2_ttf_font_render_UNICODE_shaded,      ARGS_REQ(9));
  mrb_define_method(mrb, class_Font, "render_glyph_shaded",       mrb_sdl2_ttf_font_render_glyph_shaded,      ARGS_REQ(9));
  mrb_define_method(mrb, class_Font, "render_text_blended",       mrb_sdl2_ttf_font_render_text_blended,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_UTF8_blended",       mrb_sdl2_ttf_font_render_UTF8_blended,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_UNICODE_blended",       mrb_sdl2_ttf_font_render_UNICODE_blended,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_glyph_blended",       mrb_sdl2_ttf_font_render_glyph_blended,      ARGS_REQ(5));
  mrb_define_method(mrb, class_Font, "render_text_blended_wrapped",       mrb_sdl2_ttf_font_render_text_blended_wrapped,      ARGS_REQ(6));
  mrb_define_method(mrb, class_Font, "render_UTF8_blended_wrapped",       mrb_sdl2_ttf_font_render_UTF8_blended_wrapped,      ARGS_REQ(6));
  mrb_define_method(mrb, class_Font, "render_UNICODE_blended_wrapped",       mrb_sdl2_ttf_font_render_UNICODE_blended_wrapped,      ARGS_REQ(6));
  mrb_define_method(mrb, class_Font, "get_kerning_size",       mrb_sdl2_ttf_font_get_kerning_size,      ARGS_REQ(2));
